    ...
    <b-container class="main d-flex align-items-center justify-content-center">
      <div class="col-6">
        <b-form @submit.stop.prevent="onSubmit">
          ...
          <b-form-group id="example-input-group-3" label="Re-Password" label-for="example-input-3">
            <b-form-input
              id="example-input-3"
              type="password"
          ...
          <div class="mt-4">
            <b-button type="submit" class="ml-2" variant="primary">Create new account</b-button>
            <b-button class="ml-2" variant="info" @click="backLogin()">Login page</b-button>
          </div>
        </b-form>
      </div>
    </b-container>
